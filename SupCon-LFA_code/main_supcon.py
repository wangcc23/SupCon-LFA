...
from util import SupConResNet,SupConLoss
...
def parse_option():
    ...
    parser.add_argument('--learning_rate', type=float, default=0.005,
                        help='learning rate')
    parser.add_argument('--lr_decay_epochs', type=str, default='15,30,45',
    ...
    parser.add_argument('--size', type=int, default=448, help='parameter for Resized')
    # method
